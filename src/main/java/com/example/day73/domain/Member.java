...
public class Member implements UserDetails {
    ...
    @Builder
    public Member(String userId, String password, String passwordCheck, String name,String auth, String phone, String email, String sample4_postcode, String sample4_roadAddress, String sample4_detailAddress){
        this.userId = userId;
